					...
					content: (
						<div className="space-y-2 text-sm text-zinc-300">
							...
							<p>
								...
								<span className="text-indigo-300 font-medium">fixed-size</span>{" "}
								(split every N characters — fast, oblivious to content),{" "}
								<span className="text-indigo-300 font-medium">recursive</span>{" "}
								(walk a hierarchy of separators like paragraph → sentence → word
								— LangChain's default), and{" "}
								<span className="text-indigo-300 font-medium">semantic</span>{" "}
