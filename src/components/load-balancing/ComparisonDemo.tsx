			...
			<div className="space-y-8">
				...
				<div className="flex gap-3">
					<button
						...
						onClick={runScenario}
						disabled={running}
						className="px-6 py-3 bg-violet-600 hover:bg-violet-500 disabled:bg-violet-600/50 disabled:cursor-not-allowed rounded-lg font-medium transition-colors text-white"
					>
					...
					<button
						...
						onClick={reset}
						disabled={running}
						className="px-4 py-3 bg-zinc-700 hover:bg-zinc-600 disabled:opacity-50 disabled:cursor-not-allowed rounded-lg font-medium transition-colors text-zinc-200"
					>
						Reset
					</button>
				</div>
				...
				<div className="grid md:grid-cols-3 gap-6">
					{(
						...
						const algorithmConfig: Record<
							Algorithm,
							{ title: string; barBg: string; metricBox: string }
						> = {
							"round-robin": {
								title: "Round-Robin",
								barBg: "bg-violet-500",
								metricBox: "bg-violet-500/20 border-violet-500/30",
							},
							"least-connections": {
								title: "Least Connections",
								barBg: "bg-cyan-500",
								metricBox: "bg-cyan-500/20 border-cyan-500/30",
							},
							"consistent-hashing": {
								title: "Consistent Hashing",
								barBg: "bg-amber-500",
								metricBox: "bg-amber-500/20 border-amber-500/30",
							},
						};
						...
						return (
							...
							>
								...
								{/* Metrics */}
								<div
									className={`${config.metricBox} border rounded-lg p-4 space-y-2`}
								>
									<div className="flex justify-between text-sm">
