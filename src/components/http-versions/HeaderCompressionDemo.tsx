...
export function HeaderCompressionDemo() {
	...
	return (
		<DemoSection
			title="Demo 3: Header Compression (HPACK)"
					...
					<div className="p-4 rounded-xl bg-zinc-900 border border-zinc-700 space-y-3">
						...
						<div className="space-y-2 text-xs text-zinc-400">
							...
							<div className="flex gap-2">
								...
								<span>
									...
									<code className="text-violet-300">:path</code>) are
									transmitted in full.
								</span>
							</div>
							<div className="flex gap-2">
						...
						<div className="p-2.5 rounded-lg bg-cyan-500/10 border border-cyan-500/20">
							<p className="text-xs text-cyan-300">
								Cookie-heavy APIs benefit most — a 180-byte cookie header
								becomes ~4 bytes on subsequent requests (index only).
							</p>
						</div>
					</div>
				</div>
