...
export function ServerPushDemo() {
	...
	return (
		<DemoSection
			title="Demo 4: Server Push & Early Hints"
    ...
    stream.respondWithFile('index.html');
								...
								<div className="p-3 rounded-lg bg-amber-500/10 border border-amber-500/20">
									<p className="text-xs text-amber-300">
										<span className="font-semibold">Deprecated:</span> Server
										Push was removed from Chrome in 2022. It could push
										resources the client already had cached, wasting bandwidth.
