			...
			<div className="space-y-8">
				...
				<div className="bg-zinc-900 border border-zinc-700 rounded-lg p-8">
					<div className="flex items-center justify-around relative">
						...
						>
							...
							<div className="text-xs text-center text-cyan-400 -mt-8">
								TIMER
							</div>
						</motion.div>
					</div>
				...
				<div className="flex flex-col items-center gap-4">
					<button
						...
						className="px-6 py-3 bg-cyan-500/20 text-cyan-300 border border-cyan-500/30 hover:bg-cyan-500/30 disabled:bg-zinc-800 disabled:text-zinc-500 disabled:border-zinc-700 rounded-lg font-medium transition-colors"
					>
						{isTransitioning
							? "Transitioning..."
