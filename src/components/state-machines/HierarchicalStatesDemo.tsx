			...
			<div className="space-y-8">
					...
					<div className="space-y-4">
										...
										<AnimatePresence>
											{playerState.status === "playing" && (
												<motion.div
													...
													className="space-y-2 pl-4 border-l-2 border-cyan-500/50"
												>
													{(["normal", "buffering"] as const).map(
														(substatus) => (
															<motion.div
																key={substatus}
						...
						<div className="bg-zinc-800 rounded-lg p-6 space-y-4">
							...
							<div className="relative h-2 bg-zinc-700 rounded-full overflow-hidden">
								<motion.div
									className="absolute inset-y-0 left-0 bg-linear-to-r from-blue-500 to-cyan-500"
							...
							<div className="flex items-center justify-center gap-3">
								<button
									...
									className="p-3 bg-cyan-500/20 text-cyan-300 border border-cyan-500/30 hover:bg-cyan-500/30 disabled:bg-zinc-800 disabled:text-zinc-600 disabled:border-zinc-700 rounded-full transition-colors"
									title="Play"
								>
				...
				<div className="bg-zinc-900 border border-zinc-700 rounded-lg p-6">
					...
					<div className="mt-4 text-xs text-zinc-400">
						<strong className="text-cyan-300">Parallel states</strong> operate
				...
				<div className="grid md:grid-cols-2 gap-4">
					...
					<div className="bg-cyan-950/30 border border-cyan-800/50 rounded-lg p-4">
						<div className="text-sm text-cyan-300">
							...
							independently. The player can be online/offline AND muted/unmuted
							in any combination. 4 possible combinations, all valid.
						</div>
					</div>
				</div>
			</div>
