										...
										<div className="flex items-start gap-2">
											...
											<div className="text-sm text-rose-300">
												...
												<div className="text-xs text-rose-400 mt-1">
													{getBooleanStateCount()} flags are true
													simultaneously. This should never happen.
												</div>
											</div>
										</div>
									</motion.div>
						...
						<div className="bg-zinc-900 border border-zinc-700 rounded-lg p-6 space-y-4 min-h-[400px]">
							...
							<div className="border-t border-zinc-700 pt-4">
								<button
									...
									className="w-full px-4 py-2 bg-cyan-500/20 text-cyan-300 border border-cyan-500/30 hover:bg-cyan-500/30 disabled:bg-zinc-800 disabled:text-zinc-500 disabled:border-zinc-700 rounded-lg text-sm font-medium transition-colors"
								>
									Fetch Data
								</button>
							</div>
