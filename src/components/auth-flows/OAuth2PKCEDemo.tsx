			...
			<div className="space-y-8">
				...
				<div className="space-y-3">
					<div className="bg-emerald-500/10 border border-emerald-500/30 rounded-lg p-4">
						...
						<p className="text-sm text-emerald-200">
							PKCE prevents authorization code interception attacks. Required
							for SPAs since OAuth 2.1 (2019). The verifier stays on the client,
							only the challenge is sent to the provider.
						</p>
					</div>
