					...
					<div>
						...
						<p className="text-sm text-zinc-400 mt-1 max-w-xl">
							...
							<span className="text-orange-400 mt-2 inline-block">
								...
								20,000! Per-table stats are accurate — this is a join
								selectivity misestimate (e.g. correlated columns).
							</span>
						</p>
					</div>
				</div>
							...
							<div className="space-y-5">
								...
								{isBadEstimate && (
									...
									>
										...
										bad query plans (e.g. picking Hash Join vs Nested Loop).
										Fix: Run <code>ANALYZE users; ANALYZE orders;</code> and
										consider <code>CREATE STATISTICS</code> for correlated
										columns.
									</motion.div>
								)}
							</div>
